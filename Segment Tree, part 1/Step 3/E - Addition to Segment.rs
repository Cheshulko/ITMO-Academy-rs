...
fn main() {
    ...
    for _ in 0.._t {
        ...
        let mut b = vec![0; n + 1];
        let mut tree: cm_seg_tree::SegmentTree<i64> =
            cm_seg_tree::SegmentTree::from_vec(&b, |a, b| a + b);

        for _ in 0..m {
            let t = cin.next::<usize>();
            if t == 1 {
                let (l, r, v) = (cin.next::<usize>(), cin.next::<usize>(), cin.next::<i64>());
